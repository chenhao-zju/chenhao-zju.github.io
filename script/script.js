...
noButton.addEventListener('click', function () {
    ...
    // 图片变化（前 5 次变化）
    if (clickCount === 1) mainImage.src = "images/images/shocked.png"; // 震惊
    if (clickCount === 2) mainImage.src = "images/images/think.png"; // 思考
    if (clickCount === 3) mainImage.src = "images/images/angry.png"; // 生气
    if (clickCount === 4) mainImage.src = "images/images/crying.png"; // 哭
    if (clickCount >= 5) mainImage.src = "images/images/crying.png"; // 之后一直是哭
});
...
yesButton.addEventListener('click', function () {
    ...
    document.body.innerHTML = `
        <div class="yes-screen">
            ...
            <img src="images/images/hug.png" alt="拥抱" class="yes-image">
        </div>
    `;
    // 确保用户名安全地插入
